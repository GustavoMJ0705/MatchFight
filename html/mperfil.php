...
<div class="btn-group">
                ...
                <button type="button" class="btn-apagar" onclick="apagarUsuario()" name="botaoDel" style= "align-items: center">Apagar Usuário</button>
                
                <a href="editperfil.php" class="editbtn">Editar meu perfil</a>
            </div>
        </form>
...
function apagarUsuario() {
    if (confirm("Tem certeza que deseja apagar sua conta?")) {
        var senha = prompt("Digite sua senha para confirmar:");
        if (senha !== null && senha !== "") {
