...
<body>
    ...
    <form action="../php/autaluno.php" method="POST">
        ...
        <input type="date" id="nascimento" name="nascimento" placeholder="DD/MM/AAAA" maxlength="8" required pattern="\d{2}/\d{2}/\d{4}" title="Formato: DD/MM/AAAA">
       ...
       <label for="dojoPhone">Telefone:</label>
        <input type="tel" id="telefone" name="telefone" placeholder="(XX) XXXXX-XXXX" onkeydown="return apenasNumeros(event)" minlength="8" maxlength="11" required>
