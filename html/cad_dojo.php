...
<body>
    <div class="logo">
     ...
     <form action="../php/autdojo.php" method="POST">  
        ...
        <label for="cep">CEP da academia:</label>
       <input type="text" id="dojoCEP" name="dojoCEP" required>
        <br>

        <label for="dojoPhone">Telefone:</label>
        <input type="tel" id="dojoPhone" name="dojoPhone" placeholder="XXXXX-XXXX" onkeydown="return apenasNumeros(event)" minlength="8" maxlength="12" required>
        <br>
